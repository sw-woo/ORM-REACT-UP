...
//선택적 속성은 선언된 타입을 사용할때 해당 선택적 옵션을 사용해도되고 안해도 될 수 있게 하는 기능을 지원
...
export default function BlogCreate() {
	...
	//타입스크립트에서의 any 타입으로 지정하면 타입에러를 발생시키지 않습니다.
	//타입을 지정하기 애매한 경우 주로 any타입으로 지정해서 타입스크립트 에러를 피해갈수 있게 사용하는 타입
